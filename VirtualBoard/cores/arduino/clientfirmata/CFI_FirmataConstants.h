...
#ifndef CFI_FirmataConstants_h
#define CFI_FirmataConstants_h

namespace clientFirmataInternal
{
// message command bytes (128-255/0x80-0xFF)

static const int DIGITAL_MESSAGE =
  0x90; // send data for a digital port (collection of 8 pins)
...
static const int ROUTE_MESSAGE =
  0xF8; // route a message to a node which id (0...127) will follow this command

// extended command set using sysex (0-127/0x00-0x7F)
/* 0x00-0x0F reserved for user-defined commands */

static const int SERIAL_DATA =
  0x60; // communicate with serial devices, including other boards
static const int ENCODER_DATA =            0x61; // reply with encoders current positions
static const int ACCELSTEPPER_DATA =       0x62; // control a stepper motor
static const int SPI_DATA =                0x68; // SPI Commands start with this byte
...
static const int ONEWIRE_DATA =
  0x73; // send an OneWire read/write/reset/select/skip/search request
...
static const int CAPABILITY_QUERY =
...
static const int SCHEDULER_DATA =
  0x7B; // send a createtask/deletetask/addtotask/schedule/querytasks/querytask request to the scheduler
...
static const int PIN_MODE_DEBOUNCE =        0x0C; // pin configured for digital debounce input
static const int PIN_MODE_DEBOUNCE_ANALOG = 0x0D; // pin configured for analog debounce input
static const int PIN_MODE_IGNORE =
  0x7F; // pin configured to be ignored by digitalWrite and capabilityResponse

static const int TOTAL_PIN_MODES =          15;
