/*
  SpiWrapper.h - Part of the VirtualBoard project
...
class __declspec(dllexport) SpiWrapper
{
  private:
    SpiWrapperPrivate* _private;
  ...
  public:
    ...
    void transfer(const unsigned char *tbuf, const unsigned char* rbuf, unsigned int size);
};
